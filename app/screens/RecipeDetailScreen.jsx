    ...
    >
      ...
      <View className='flex-row'>
        <Image
          ...
          style={{ width: '100%', height: hp(50), borderBottomLeftRadius: 40, borderBottomRightRadius: 40 }}
          // style={{ borderRadius: 53, borderBottomLeftRadius: 40, borderBottomRightRadius: 40, marginTop: 4}}
        />
      </View>
        ...
        loading ? (
          ...
          <View className='px-4 flex justify-between space-y-4 pt-8'>
            ...
            <View className='space-y-2'>
              <Text style={{ fontSize: hp(3) }} className='font-bold text-neutral-700 flex-1'>
                {mealData.strMeal}
              </Text>
              <Text style={{ fontSize: hp(2) }} className='font-medium text-neutral-500 flex-1'>
                {mealData.strArea}
              </Text>
            </View>
                  ...
                  return (
                    <View key={i} className='flex-row space-x-4'>
                      ...
                      <View className='flex-row space-x-2'>
                        <Text style={{ fontSize: hp(1.7) }} className='font-extrabold text-neutral-700'>{mealData['strMeasure'+i]}</Text>
